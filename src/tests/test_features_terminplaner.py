...
def test_is_time_in_range():
    ...
    # Aktuelle Uhrzeit auf 12:03 setzen
    current_time = datetime.strptime("12:03", "%H:%M").time()
    # Setze die aktuelle Zeit in Terminplaner
    terminplaner.current_time = current_time
